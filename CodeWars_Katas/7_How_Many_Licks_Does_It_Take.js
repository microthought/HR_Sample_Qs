...
the center of a Tootsie Pop. Twenty of the group's volunteers assumed the licking 
...
"It took 260 licks to get to the tootsie roll center of a tootsie pop. The toughest 
challenge was freezing temps."

Other cases: If there are no challenges, the toughest challenge sentence should be 
omitted. If there are multiple challenges with the highest toughest amount, the 
first one presented will be the toughest. If an environment variable is present, 
it will be either a positive or negative integer. No need to validate.
...
function totalLicks(env) {
  ...
  let licksText = "It took "+ licks +" licks to get to the tootsie roll center of a tootsie pop."
  if(biggest) challengeText = " The toughest challenge was " + biggestName + ".";

  return licksText + challengeText;
}
