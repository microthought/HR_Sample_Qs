...
var vow2num = function(letter){ return num.charAt(vow.indexOf(letter)); };

var num2vow = function(number){ return vow.charAt(num.indexOf(number)); };

// turn vowels into numbers
function encode(string){
  return string.replace(/[aeiou]/gi, vow2num)
}

//turn numbers back into vowels
function decode(string){
  return string.replace(/\d/gi, num2vow)
}
